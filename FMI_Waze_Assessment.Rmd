...
- Through this effort, we developed general-purpose query and data processing scripts in GitLab which can be used by other teams. The code collaboration tools in the SDC provide a means for future analysts to replicate and build on the analysis presented here.
...
- Collaboration across SDC teams
  + Use of GitLab 
  + Shared code within and across teams
  + Collaboration 
