...
Competency in modern data science skills are required to be an effective user of the SDC. There are general data analysis skills which users should  
...
In addition, beyond these data science skills effecitve use of the SDC is facilitated by the following skills:

- Understanding the where data exist and how to share files.
  + Data Warehouse
  + Team S3 buckets - Data and file sharing with a team is acheived with team S3 buckets.
  + Local instance
...
- Planning a project in a secure computing platform: 
  ...
  + Uploading user-supplied data
  + Export request process

- Ways to make your workflow better: Optimize code, optimize instance, or optimize data warehouse configuration. 
  + Optimize code
  + Cloud instance management. Understanding parallelization, optimizing instance configuration. 
  + Working with SDC team to make changes to data warehouse.
...
- Documentation of where data exist at different points in the pipeline is not obvious (or does not exist). Meaning: ingestion, curation, persistence, derived data.
  + QA/QC documented on the data sets. 
  + Dashboard of data quality over time for each data set. 
  + Record of updates to data sets (e.g. historical Waze data for April - December 2019 had gaps before 2020-05-15, but was fixed after 2020-05-15).

- General purpose example data set for user guide and working examples.
  + Code Academy style demo. 
  + Census shapefiles + VMT data from public sources
